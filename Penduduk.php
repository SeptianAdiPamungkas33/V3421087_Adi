            ...
            <div class="card card-danger">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" name="pekerjaan" placeholder="Enter Nama" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" name="tempatlahir" placeholder="Enter Nama" required>
                </div>

                <div class="form-group">
                  <label for="nama">Tanggal Lahir</label>
                  <input type="date" class="form-control" id="nama" name="tanggallahir" placeholder="Enter Nama" required>
                </div>
